            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah CPL</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="shadow-sm card">
                    <div class="text-center card-header">
                        <h5 class="mb-0">Tambah CPL</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('learning-outcomes.store', ['batch' => $batch, 'position' => $position]) }}" method="POST">
                            @csrf
                            <div class="mb-3">
