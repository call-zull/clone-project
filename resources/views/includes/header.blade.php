        ...
        <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
            ...
            <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                    data-bs-toggle="dropdown"> <img src="{{ asset('assets') }}/assets/img/user2-160x160.jpg"
                        class="shadow user-image rounded-circle" alt="User Image"> <span class="d-none d-md-inline">
                        {{ Auth::user()->name }}</span> </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                    <li class="user-header text-bg-primary"> <img
                            src="{{ asset('assets') }}/assets/img/user2-160x160.jpg" class="shadow rounded-circle"
                            alt="User Image">
                        <p>
                            {{ Auth::user()->name }}</span>
                        </p>
