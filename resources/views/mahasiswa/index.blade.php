<x-app-layouts>
                                            ...
                                            <table class="table text-center table-bordered">
                                                ...
                                                <tbody class="text-nowrap">
                                                    <tr class="align-middle">
                                                        ...
                                                        <td>revision</td>
                                                        <td>
                                                            <button class="btn btn-success text-nowrap">aprove</button>
                                                        </td>
                                                    </tr>
    ...
    <div class="modal fade" id="revisiModal" tabindex="-1" aria-labelledby="revisiModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addActivityModalLabel">Log Revisi Activity
                    </h5>
                ...
                <div class="modal-body">
                    <form action="#" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="activityDescription" name="activity_description" rows="3" readonly>revisi dulu</textarea>
                        </div>
                    </form>
                </div>
            </div>
